...
module.exports = {
  ...
  generateFile: function(rdfFile, targetHdtFile, config, callback, progressCallback, self) {
    if (typeof config === 'function') progressCallback = callback, callback = config, config = {};
    if (typeof callback !== 'function') throw new Error('No callback provided');

    if (progressCallback === undefined) {
      progressCallback = function(){};
    } else if (typeof progressCallback !== 'function') {
      return callback.call(self, Error('Invalid progress callback: ' + progressCallback));
    }
    ...
    if (typeof config !== 'object')
      return callback.call(self, Error('Invalid config object: ' + config));
